...
ALTER TABLE "transcriptions" ADD COLUMN "provider" varchar(100) NOT NULL DEFAULT 'openai';--> statement-breakpoint
ALTER TABLE "transcriptions" ADD COLUMN "model" varchar(100) NOT NULL DEFAULT 'whisper-1';--> statement-breakpoint
